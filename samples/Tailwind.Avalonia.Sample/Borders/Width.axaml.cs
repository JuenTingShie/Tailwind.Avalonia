...
public partial class Width : UserControl
{
    ...
    [
        ...
        new("border-s-[<value>]", "LTR <Border BorderThickness=\"<parsed>,0,0,0\" />; RTL <Border BorderThickness=\"0,0,<parsed>,0\" />"),
        ...
        new("border-e-[<value>]", "LTR <Border BorderThickness=\"0,0,<parsed>,0\" />; RTL <Border BorderThickness=\"<parsed>,0,0,0\" />"),
        new("border-bs", "<Border BorderThickness=\"0,1,0,0\" />"),
        new("border-bs-<number>", "<Border BorderThickness=\"0,<number>,0,0\" />"),
        new("border-bs-[<value>]", "<Border BorderThickness=\"0,<parsed>,0,0\" />"),
        new("border-be", "<Border BorderThickness=\"0,0,0,1\" />"),
        new("border-be-<number>", "<Border BorderThickness=\"0,0,0,<number>\" />"),
        new("border-be-[<value>]", "<Border BorderThickness=\"0,0,0,<parsed>\" />"),
    ];
